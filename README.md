...
####  Workflows 1 and 2 : user is not authenticated on network participant 
##### Advertiser side:
...
<ins>Workflow 1 : user is not authenticated on network participant AND user is not authenticated on Network Controller</ins>
...
<ins>Workflow 2: User is not authenticated on network participant AND user is authenticated on the Network Controller</ins>
...
<ins>Workflow 2 : user is not authenticated on network participant AND user is authenticated on Network Controller</ins>
...
##### Advertiser side (example here: user is signing-up on network participant):
...
##### Publisher side (example here: user is already authenticated on network participant):
